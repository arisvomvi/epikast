...
!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).Vue = e());
})(this, function () {
  'use strict';
  var t = Object.freeze({}),
    e = Array.isArray;
  ...
  var St = { notify: j, depend: j, addSub: j, removeSub: j },
    Ot = (function () {
      function t(t, n, r) {
        if (
          (void 0 === n && (n = !1), void 0 === r && (r = !1), (this.value = t), (this.shallow = n), (this.mock = r), (this.dep = r ? St : new mt()), (this.vmCount = 0), z(t, '__ob__', this), e(t))
        ) {
          if (!r)
            if (K) t.__proto__ = $t;
            else
  ...
  function Tt(t, n, r) {
    return t && _(t, '__ob__') && t.__ob__ instanceof Ot
      ? t.__ob__
      : !Ct || (!r && rt()) || (!e(t) && !u(t)) || !Object.isExtensible(t) || t.__v_skip || Ft(t) || t instanceof lt
      ? void 0
      : new Ot(t, n, r);
  }
  ...
  var un = (function () {
    function t(t) {
      void 0 === t && (t = !1),
        ...
        (this.cleanups = []),
        (this.parent = an),
        !t && an && (this.index = (an.scopes || (an.scopes = [])).push(this) - 1);
    }
    return (
  ...
  function dr(t, e, n) {
    ...
    for (var r, o, i, a = st ? Reflect.ownKeys(e) : Object.keys(e), s = 0; s < a.length; s++)
      '__ob__' !== (r = a[s]) && ((o = t[r]), (i = e[r]), n && _(t, r) ? o !== i && u(o) && u(i) && dr(o, i) : jt(t, r, i));
    return t;
  }
  function pr(t, e, n) {
    return n
    ...
    (t.data.directives || e.data.directives) &&
      (function (t, e) {
        ...
        for (n in c)
          (r = s[n]),
            (o = c[n]),
            r ? ((o.oldValue = r.value), (o.oldArg = r.arg), ho(o, 'update', e, t), o.def && o.def.componentUpdated && l.push(o)) : (ho(o, 'bind', e, t), o.def && o.def.inserted && u.push(o));
        if (u.length) {
          var f = function () {
  ...
  function Ko(t, e) {
    var n = (function (t) {
      if (((t = t.trim()), (wo = t.length), t.indexOf('[') < 0 || t.lastIndexOf(']') < wo - 1))
        return (ko = t.lastIndexOf('.')) > -1 ? { exp: t.slice(0, ko), key: '"' + t.slice(ko + 1) + '"' } : { exp: t, key: null };
      (xo = t), (ko = So = Oo = 0);
  ...
  function Ri(t, e) {
    ...
    return (
      e === Si
        ...
        : (f = (n = (l = Math.max(a, u)) > 0 ? (a > u ? Si : Oi) : null) ? (n === Si ? i.length : c.length) : 0),
    ...
    inserted: function (t, e, n, r) {
      'select' === n.tag
        ...
        : ('textarea' === n.tag || Qr(t.type)) &&
          ...
          e.modifiers.lazy || (t.addEventListener('compositionstart', Yi), t.addEventListener('compositionend', Qi), t.addEventListener('change', Qi), Z && (t.vmodel = !0)));
    },
        ...
        u = function () {
          if (((n = t), r && La(r))) {
            ...
            w = t.replace(p, function (t, n, r) {
              return (
                (u = r.length),
                La(d) || 'noscript' === d || (n = n.replace(/<!\--([\s\S]*?)-->/g, '$1').replace(/<!\[CDATA\[([\s\S]*?)]]>/g, '$1')),
                za(d, n) && (n = n.slice(1)),
                e.chars && e.chars(n),
                ''
              );
                ...
                a &&
                  ...
                  a.sync &&
                    ...
                    c
                      ...
                      : (Fo(t, 'update:'.concat(w(r)), s, null, !1, 0, u[e]), k(r) !== w(r) && Fo(t, 'update:'.concat(k(r)), s, null, !1, 0, u[e])))),
  ...
  function Ws(t, e) {
    ...
    var n = e.pre;
    return (
      t.pre && (e.pre = t.pre), e.staticRenderFns.push('with(this){return '.concat(qs(t, e), '}')), (e.pre = n), '_m('.concat(e.staticRenderFns.length - 1).concat(t.staticInFor ? ',true' : '', ')')
    );
  }
  function Zs(t, e) {
  ...
  function Qs(t, e) {
    ...
    return (
      (n = n.replace(/,$/, '') + '}'),
      t.dynamicAttrs && (n = '_b('.concat(n, ',"').concat(t.tag, '",').concat(ic(t.dynamicAttrs), ')')),
  ...
  function ec(t, e) {
    ...
    var r = t.slotScope === ps ? '' : String(t.slotScope),
      o =
        'function('.concat(r, '){') +
        'return '.concat('template' === t.tag ? (t.if && n ? '('.concat(t.if, ')?').concat(nc(t, e) || 'undefined', ':undefined') : nc(t, e) || 'undefined') : qs(t, e), '}'),
      i = r ? '' : ',proxy:true';
    return '{key:'
