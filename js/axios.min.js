                      ...
                      (i = e) &&
                        i.split('\n').forEach(function (e) {
                          (u = e.indexOf(':')),
                            ...
                            !a || (c[a] && ce[a]) || ('set-cookie' === a ? (c[a] ? c[a].push(s) : (c[a] = [s])) : (c[a] = c[a] ? c[a] + ', ' + s : s));
                        }),
                      c),
                      t
                    )
            ...
            if (u) {
              ...
              !(function (e, t, n) {
                ...
                n.status && r && !r(n.status)
                  ? t(new F('Request failed with status code ' + n.status, [F.ERR_BAD_REQUEST, F.ERR_BAD_RESPONSE][Math.floor(n.status / 100) - 4], n.config, n.request, n))
                  : e(n);
              })(
                function (e) {
                  t(e), s();
        ...
        r(e, [
          {
            ...
            value: function (e, t) {
              ...
              var n,
                ...
                a = r.headers;
              void 0 !== o &&
                Pe.assertOptions(o, { silentJSONParsing: _e.transitional(_e.boolean), forcedJSONParsing: _e.transitional(_e.boolean), clarifyTimeoutError: _e.transitional(_e.boolean) }, !1),
